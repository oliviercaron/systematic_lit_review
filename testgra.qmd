...
#| column: screen
#| fig-dpi: 300
#| fig-cap: "Figure 1: Missing values in the list of articles"
#| fig-alt: "Missing values in the list of articles"
...
def create_graph(dataframe, start_year, end_year):
    ...
    Sigma.write_html(G,
                 ...
                 path                    = f"networks/authors/{start_year}_{end_year}_sigma_test11.html", # Output file path
...
#From 0 to 2015
G_0_2015, df_0_2015 = create_graph(list_articles, 0, 2015)
#From 2014 to 2019
G_2014_2019, df_2014_2019 = create_graph(list_articles, 2014, 2019)
# From 2015 to 2019
G_2015_2019, df_2015_2019 = create_graph(list_articles, 2015, 2019)
# From 2018 to 2022
G_2018_2022, df_2018_2022 = create_graph(list_articles, 2018, 2022)
# From 2021 to 2023
G_2021_2023, df_2021_2023 = create_graph(list_articles, 2021, 2023)
```
