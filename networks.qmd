...
nx.set_node_attributes(G, nx.degree_centrality(G), 'size')
...
```{=html}
<iframe width="1000" height="1000" src="networks/network_2022_2023.html" title="Quarto Documentation" frameborder=0 class="column-body-outset"></iframe>
```
