...
# Keep only marketing articles
list_articles <- list_articles %>% filter(marketing == 1)
...
def sigma_graph(dataframe, year_period):
    ...
    Sigma.write_html(G,
        node_metrics={"community": {"name": "louvain", "resolution": 1.5}},  # Specify node metrics. increase resolution to have 
