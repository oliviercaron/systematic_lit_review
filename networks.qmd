...
net = Network(notebook=True, width=1400, height=1000, bgcolor="black", font_color="white")
...
```{=html}
<iframe width="1400" height="1000" src="network_2022_2023.html" title="Quarto Documentation" frameborder="0></iframe>
```
