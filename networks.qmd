...
```{=html}
<iframe width="1400" height="800" src="network_2022_2023.html" title="Quarto Documentation" frameborder="0></iframe>
```
...
BLALBLABLA
BLALBLA
JUST some space for the other network test

```{=html}
<iframe width="1400" height="800" src="network_2022_2023_circular.html" title="Quarto Documentation" frameborder="0></iframe>
```
