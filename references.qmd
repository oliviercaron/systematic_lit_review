...
Here, we want to get an overview of important articles in the field of marketing using NLP methods. To do so, we construct the same network as before but analyzing references.
...
reactable(
  ...
  columns = list(
    ...
    author_list_author_preferred_name_ce_indexed_name = colDef(name = "Title", minWidth = 60, align = "center"),
    prism_coverDate = colDef(name = "Date", minWidth = 40, align = "center"),
    title = colDef(name = "Author", minWidth = 100, align = "center"),
