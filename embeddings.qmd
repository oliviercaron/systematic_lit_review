...
topic_model_mpnet = BERTopic(ctfidf_model=ctfidf_model, calculate_probabilities=True, verbose=True, min_topic_size=5, nr_topics=14, vectorizer_model=vectorizer_model)
...
```{python}
topicsinfo = topic_model.get_topic_info()[1:]
topicsinfo
```
