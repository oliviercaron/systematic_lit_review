...
# tokenize sentences and train the Word2Vec model
vector_size = 100   # Set the embedding vector size
window_size = 7     # Define the context window size
min_count = 50      # Ignore words with a frequency below min_count
sg = 0              # Use CBOW (or skip-gram if sg=1)

# tokenize the marketing documents into sentences
...
# now, we can access word embeddings; for instance:
