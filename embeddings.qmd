...
| embeddings_model | Specifies the embeddings model we cant to load and use                                                                                                                                                                    |
...
def create_bertopic(docs ,embeddings_model, min_topic_size, nr_topics):
    ...
    topic_model = BERTopic(ctfidf_model=ctfidf_model, calculate_probabilities=True, verbose=True, min_topic_size=min_topic_size, nr_topics=nr_topics)
...
```{python}
fig_docuuments = topic_model_mpnet.visualize_documents(docs_marketing, embeddings=embeddings_mpnet)
fig_docuuments.write_html("test_viz_documents.html")
